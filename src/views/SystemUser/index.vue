...
<!--        </div>-->
      ...
      <el-col :span="10" style="height: 100%">
        ...
        >
          ...
          <el-form-item label="serverNode" prop="serverNode">
            <el-input v-model="form.serverNode" clearable></el-input>
          </el-form-item>
          <el-form-item label="serverUrl" prop="serverUrl">
            <el-input v-model="form.serverUrl" clearable></el-input>
          </el-form-item>
          <el-form-item label="visitorUrl" prop="visitorUrl">
            <el-input v-model="form.visitorUrl" clearable></el-input>
          </el-form-item>
