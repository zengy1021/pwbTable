            ...
            <template slot-scope="props">
              <el-form label-position="left" inline class="demo-table-expand expend_content">
                ...
                <el-form-item label="对话内容">
                  <template slot="label">
                    <span class="expand_label">{{'对话内容'}}</span>
                  </template>
                  <span class="break_all" style="white-space: pre-wrap;">{{ props.row.chatContent }}</span>
                </el-form-item>
                </el-row>
                <el-row>
...
<!--                </el-row>-->
        ...
        <el-table-column width="140" prop="chatRecordType" label="记录类型"> </el-table-column>
        <el-table-column width="140" prop="chatEvent" label="对话事件类型"> </el-table-column>
